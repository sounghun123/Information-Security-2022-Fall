...
def verify(hash, key, signature):
	...
	key_value = RSA.import_key(decode_base64(key))
	signature_value = decode_base64(signature)
	try:
		pkcs1_15.new(key_value).verify(hash, signature_value)
		return True
...
server_pubkey = cert['serverPubKey']
